...
**Atomicity.** Эта команда делает только то, что в имени: коммит и push. Тесты, ревью, обновление документации — отдельные шаги, которые ты или main-сессия запускаешь до или после, по своей инициативе или через pre-merge триаду. Команда не должна их вызывать.
