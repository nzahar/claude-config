...
This is the Codex adapter for `/Users/zakharnedashkovskiy/.claude/commands/statusbar-doctor.md`.

When this skill is selected:

1. Read `/Users/zakharnedashkovskiy/.claude/commands/statusbar-doctor.md` completely before taking action.
