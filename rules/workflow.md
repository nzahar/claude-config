...
- **D8. Risk plausibility in plans.** A mitigation in `docs/plans/*.md` — a step, gate or fallback framed as guarding against a risk — earns its place only when the risk has named evidence. Hypothetical risks are one line or cut.
