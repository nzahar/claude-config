...
- **No severity vocabulary in this agent.** Findings are root-cause statements, not graded issues. See [`lib/state-contract.md`](../lib/state-contract.md) "No severity vocabulary in STATE.md" for the cross-agent rule.
